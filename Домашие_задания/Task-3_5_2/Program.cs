    ...
    */
    ...
    class Program
    {
        ...
        */
        ...
        static void Main() //string[] args
        {
            ...
            */
            ...
            //Ковариантность (от родителя к потомку, от Car к Bike)
            IGarageManager<Bike, Garage> garageManager2 = new GarageManagerBase(); 

            //Контравариантность (от потомка к предку, от Garage к House)
        ...
        */
        ...
        public interface IGarageManager<in T, out Z> //in - параметр является контравариантным (от потомка к предку),
                                                     //out - параметр ковариантный (от предка к потомку
        {
            Z GetGarageInfo(); // возвращает объект гаража
            void Add(T car); //добавляет новый автомобиль в гараж
